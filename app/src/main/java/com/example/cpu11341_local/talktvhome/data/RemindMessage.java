...
public class RemindMessage extends MessageDetail {
    String title;
    long eventDatetime;
    ...
    public RemindMessage(int type, User user, String text, long datetime, String title, long eventDatetime, int action_type, String action_title, String action_extra) {
