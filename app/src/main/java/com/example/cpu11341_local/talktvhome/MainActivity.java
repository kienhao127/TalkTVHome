...
//
//        for (int i=0; i<5; i++) {
//            messageDetail = new MessageDetail(3, MessageDataManager.getInstance().getUser("3", getBaseContext()),
//                    Calendar.getInstance().getTimeInMillis(), String.valueOf(i), false);
//            messageDetail.setTopicID(messageDetail.getUser().getId() +"_"+MessageDataManager.getInstance().getCurrentUser(getApplicationContext()).getId());
...
//
//        for (int i=0; i<5; i++) {
//            messageDetail = new MessageDetail(3, MessageDataManager.getInstance().getUser("2", getBaseContext()),
//                    Calendar.getInstance().getTimeInMillis(), String.valueOf(i), false);
//            messageDetail.setTopicID(messageDetail.getUser().getId() +"_"+MessageDataManager.getInstance().getCurrentUser(getApplicationContext()).getId());
//            InsertMessageTask insertMessageTask4 = new InsertMessageTask();
//            insertMessageTask4.execute(messageDetail);
...
//
//        for (int i=0; i<5; i++) {
//            messageDetail = new MessageDetail(3, MessageDataManager.getInstance().getUser("1", getBaseContext()),
//                    Calendar.getInstance().getTimeInMillis(), String.valueOf(i), false);
//            messageDetail.setTopicID(messageDetail.getUser().getId() +"_"+MessageDataManager.getInstance().getCurrentUser(getApplicationContext()).getId());
//            InsertMessageTask insertMessageTask4 = new InsertMessageTask();
//            insertMessageTask4.execute(messageDetail);
